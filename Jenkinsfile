        ...
        stage("RUN"){
            ...
            stages{
                ...
                stage("DEPLOY"){
                    steps{
                        script{
                            sshPublisher(publishers: [sshPublisherDesc(configName: 'Plesk', transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: '', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '/var/www/vhosts/tribus-business.at/tools.tribus-business.at/', remoteDirectorySDF: false, removePrefix: 'toolstribus/build/', sourceFiles: 'toolstribus/build/*/**')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true)])
